...
class Timbre:
    ...
    def filtre(self,type_filtre,frequence_coupure,largeur=200):
        ...
        print frequence_coupure
        if type_filtre == 'passe-bas':
            print "passe bas activé"
...
class Son:
    ...
    """  
    def __init__(self, volume,hauteur, timbre, enveloppe, reverb=False, vibrato=False, duree=1, debut=0):
        # Attributs constants        
...
def jouer(partition):
    ...
    """
    print "je rentre dans la fonction jouer"
    signal = np.array([])
...
#CADRE ENVELOPPE        
        ...
        self.cadre_enveloppe.setFixedWidth(350)
...
#GRAPHIQUE
    def graphique(self):   
        ...
        self.grid.addWidget(self.canvas,1,2)  # the matplotlib canvas
